...
public class StringSet {
    ...
    public StringSet(int[] mods, int maxLen) {
        ...
        BigInteger bigAlpha = new BigInteger(String.valueOf(ALPHABET_SZ));
    ...
    public static void main(String[] args) {
        StringSet stringSet = new StringSet(128);
        stringSet.addAllSubstrings("abcd");
