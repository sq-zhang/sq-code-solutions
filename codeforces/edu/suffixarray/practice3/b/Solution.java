package codeforces.edu.suffixarray.practice3.b;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        while (T-- > 0) {
            ...
            int left = binarySearchLeft(t, s, p, m, n);
            if (left == -1) {
                pw.println(0);
                continue;
            }
            int right = binarySearchRight(t, s, p, m, n);
            pw.println(right - left + 1);
        }
        pw.flush();
    }

    static int binarySearchRight(String source, String target, int[] suffixArray, int m, int n) {
        int l = 0, r = n - 1;
        while(l < r) {
            int mid = l + (r - l) / 2 + 1;
        ...
        return compareStr(source, suffixArray[r], target, m, n) == 0 ? r : -1;
    }

    static int binarySearchLeft(String source, String target, int[] suffixArray, int m, int n) {
        int l = 0, r = n - 1;
        while(l < r) {
            int mid = l + (r - l) / 2;
            int res = compareStr(source, suffixArray[mid], target, m, n);
        ...
        return compareStr(source, suffixArray[l], target, m, n) == 0 ? l : -1;
    }
