                ...
                for (int j = 0; j < line.size(); j++) {
                    ...
                    if (j % 2 == 1) {
                        if (line.get(j - 1) != null) {
                            c = (line.get(j) != null) ? LINE_CHARACTER : LINE_CHARACTER;
                        } else {
                            if (line.get(j) != null) c = LINE_CHARACTER;
                        }
                    }
                    sb.append(c);
                    ...
                    if (line.get(j) == null) {
                        ...
                        for (int k = 0; k < hpw; k++) {
                            sb.append(j % 2 == 0 ? " " : LINE_CHARACTER);
                        }
                        sb.append(j % 2 == 0 ? LINE_CHARACTER : LINE_CHARACTER);
                        for (int k = 0; k < hpw; k++) {
                            sb.append(j % 2 == 0 ? LINE_CHARACTER : " ");
                        }
                    }
